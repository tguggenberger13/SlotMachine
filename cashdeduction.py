...
def play(currentmoney,perpullcost):
    ...
    if (slot1==slot2==slot3=="crown"):
        win = "\nYou win $100"
        currentmoney = currentmoney + int(100)
    ...
    if (slot1=="cherry") and (slot2=="cherry") and (slot3=="crown") or (slot1=="crown") and (slot2=="cherry") and (slot3=="cherry") or (slot1=="cherry") and (slot2=="crown") and (slot3=="cherry"):
        win = "\nYou win $25"
        currentmoney = currentmoney + int(25)
    if (slot1=="crown") and (slot2=="crown") and (slot3=="cherry") or (slot1=="crown") and (slot2=="cherry") and (slot3=="crown") or (slot1=="cherry") and (slot2=="crown") and (slot3=="crown"):
        win = "\nYou win $15"
        currentmoney = currentmoney + int(15)
